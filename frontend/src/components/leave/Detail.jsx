    ...
    const fetchLeave = async () => {
      try {
        const responnse = await axios.get(
          `https://factory-flow-app-weld.vercel.app/api/leave/detail/${id}`,
          {
            headers: {
        ...
        <div className="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="flex space-x-3 mb-2">
                <p className="text-lg font-bold">Raison:</p>
              ...
              <div className="flex space-x-3 mb-2">
                <p className="text-lg font-bold">Debut:</p>
                <p className="font-medium">{new Date(leave.startDate).toLocaleDateString()}</p>
              </div>
              <div className="flex space-x-3 mb-2">
                <p className="text-lg font-bold">Fin:</p>
                ...
                <p className="text-lg font-bold">
                    ...
                    {leave.status === "Pending" ? (
                        <div className="flex space-x-2">
                            ...
                            onClick={() => changeStatus(leave._id, "Approved")}>Apprové</button>
                            <button className="px-2 py-0.5 bg-red-300 hover:bg-red-400"
                            onClick={() => changeStatus(leave._id, "Rejected")}>Rejeté</button>
                        </div>
                    ) : 
